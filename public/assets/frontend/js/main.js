(function ($) {
        ...
        $(window).scroll(function () {
            ...
            // On scollDown
                ...
                if (currentPosition > checkpoint) {
                    header
                        .addClass("navigation--unpin")
                        .removeClass("navigation--pin");
    ...
    function mapConfig() {
        $.gmap3({
            key: "AIzaSyA1Xps6nWWTuLvzazBzYS5ut-WGJhZehkg",
        });
        var map = $("#contact-map");
        if (map.length > 0) {
            map.gmap3({
    ...
    function zoomInit() {
        ...
        var primary = $(".ps-product__image .item.slick-active")
            .first()
            .children(".zoom");
        primary.elevateZoom({
            responsive: true,
