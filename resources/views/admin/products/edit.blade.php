                ...
                <div class="pd-ltr-20 xs-pd-20-10">
                    <div class="pd-20 card-box mb-30">
                        ...
                        <div class="form-group row @if ($errors->has('stock')) has-danger @endif">
                            <label class="col-sm-12 col-md-2 col-form-label">Product Initial Stock</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control @if ($errors->has('stock')) form-control-danger @endif"
                                type="text"
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="pd-20 card-box mb-30">
                            ...
                            <div class="mb-30 form-group">
                                <input value="@foreach ($product->attributes as $attr) 
                                @if ($attr->code == 'color')
                                    {{ $attr->value . ',' }} @endif @endforeach" class="form-control"
                                    name="colors" type="text" data-role="tagsinput" placeholder="Type Color Name">
                            </div>
                        </div>
                        ...
                        <div class="pd-20 card-box mb-30">
                            ...
                            <div class="mb-30 form-group">
                                <input class="form-control" value="@foreach ($product->attributes as
                                $attr) @if ($attr->code == 'size')
                                    {{ $attr->value . ',' }} @endif @endforeach" name="sizes" type="text"
                                    data-role="tagsinput" placeholder="Type Size Name">
                            </div>
                        </div>
                        <div class="clearfix">
                            <div class="pull-left">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select2 form-control" multiple="multiple" name="categories[]"
                                style="width: 100%;">
                                @foreach ($categories as $category)
                                    <option @foreach ($product->category as $cat) {{ $cat->id == $category->id ? 'selected' : '' }} @endforeach
