                ...
                <td>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                            <a class="dropdown-item" href="{{ route('admin.product.show',  $product->id) }}"><i class="dw dw-eye"></i> View</a>
                            <a class="dropdown-item" href="{{ route('admin.product.edit',  $product->id) }}"><i class="dw dw-edit2"></i> Edit</a>
                            <a class="dropdown-item" onclick="document.getElementById('delete-form-{{$product->id}}').submit()" href="javascript:;"><i class="dw dw-delete-3"></i> Delete</a>
                            <form hidden action="{{ route('admin.product.destroy', $product->id) }}" id="delete-form-{{$product->id}}" method="post">
                            @csrf
                            @method('DELETE')
                            </form>
                        </div>
