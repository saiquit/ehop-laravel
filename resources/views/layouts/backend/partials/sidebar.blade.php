        ...
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a class="{{Request::is('admin/product') ? 'active' : ''}}"
                                href="{{ route('admin.product.index') }}">All Products</a></li>
                        <li><a class="{{Request::is('admin/product/create') ? 'active' : ''}}"
                                href="{{ route('admin.product.create') }}">Create Product</a></li>
                    </ul>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a class="{{Request::is('admin/category') ? 'active' : ''}}"
                                href="{{ route('admin.category.index') }}">All Categories</a></li>
                        <li><a class="{{Request::is('admin/category/create') ? 'active' : ''}}"
                                href="{{ route('admin.category.create') }}">Create Category</a></li>
                    </ul>
                </li>
                <li>
                    <a href="{{ route('admin.order.index') }}"
                        class="dropdown-toggle no-arrow {{Request::is('admin/order') ? 'active' : ''}}">
                        <span class="micon dw dw-house-1"></span><span class="mtext">Orders</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('customer.dashboard') }}"
                        class="dropdown-toggle no-arrow {{Request::is('customer/dashboard') ? 'active' : ''}}">
                        <span class="micon dw dw-house-1"></span><span class="mtext">Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('customer.order.index') }}"
                        class="dropdown-toggle no-arrow {{Request::is('customer/order') ? 'active' : ''}}">
