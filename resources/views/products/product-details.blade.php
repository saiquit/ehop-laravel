      ...
      <div class="col-lg-10 col-md-12 col-lg-offset-1">
        <div class="ps-product__thumbnail">
          ...
          <div class="ps-product__image">
            <div class="item"><img class="zoom" src="{{ asset('storage/images/products/'.$product->image) }}" alt=""
                data-zoom-image="{{ asset('storage/images/products/'.$product->image) }}"></div>
            @foreach ($product->images as $image)
            <div class="item"><img class="zoom" src="{{ asset('storage/images/products/'.$image->product_image) }}"
                alt="" data-zoom-image="{{ asset('storage/images/products/'.$image->product_image) }}"></div>
            @endforeach

          </div>
        </div>
        <div class="ps-product__thumbnail--mobile">
          <div class="ps-product__main-img"><img src="{{ asset('storage/images/products/'.$product->image) }}" alt="">
          </div>
          <div class="ps-product__preview owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000"
            ...
            data-owl-mousedrag="on"><img src="{{ asset('storage/images/products/'.$product->image) }}" alt=""></div>
        </div>
        <form action="{{ route('order.addtocart', $product->id) }}" method="post">
          ...
          <div class="ps-product__info">
            ...
            <h1>{{$product->title}}</h1>
            <p class="ps-product__category"> @foreach ($product->category as $category) <a
                href="#">{{$category->title}}</a> @endforeach,</p>
            ...
            <div class="ps-product__shopping"><button class="ps-btn mb-10" type="submit">Add to cart<i
                  class="ps-icon-next"></i></button>
              <div class="ps-product__actions"><a class="mr-10" href="whishlist.html"><i class="ps-icon-heart"></i></a>
              </div>
            </div>
          </div>
        </form>
            ...
            <div class="ps-shoe">
              <div class="ps-shoe__thumbnail">
                <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i
                    class="ps-icon-heart"></i></a><img src="{{ asset('storage/images/products/'.$feature->image) }}"
                  alt=""><a class="ps-shoe__overlay"
                  href="{{ route('product.details', ['slug'=> $product['slug']]) }}"></a>
              </div>
              <div class="ps-shoe__content">
                <div class="ps-shoe__variants">
                  <div class="ps-shoe__variant normal"><img src="assets/frontend/images/shoe/2.jpg" alt=""><img
                      src="assets/frontend/images/shoe/3.jpg" alt=""><img src="assets/frontend/images/shoe/4.jpg"
                      alt=""><img src="assets/frontend/images/shoe/5.jpg" alt=""></div>
