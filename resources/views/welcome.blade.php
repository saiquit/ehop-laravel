    ...
    <div class="rev_slider fullscreenbanner" id="home-banner">
        <ul>
            <li class="ps-banner" data-index="rs-2972" data-transition="random" data-slotamount="default"
                ...
                <img class="rev-slidebg" src="{{ asset('assets/frontend/images/slider/3.jpg') }}" alt=""
                ...
                <div class="tp-caption ps-banner__description" id="layer211" data-x="['left','left','left','left']"
                    ...
                    <p>Supa wanted something that was going to rep his East Coast <br> roots and, more specifically, his
                        hometown
                        of <br /> New York City in a big way.</p>
            ...
            <li class="ps-banner ps-banner--white" data-index="rs-100" data-transition="random"
                data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img
                    class="rev-slidebg" src="{{ asset('assets/frontend/images/slider/2.jpg') }}" alt=""
                    data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5"
                    data-no-retina>
    ...
    <div class="ps-container">
        <div class="ps-section__header mb-50">
            ...
            <ul class="ps-masonry__filter">
                ...
                <li><a href="#" data-filter=".{{$category['slug']}}">{{$category['title']}}
                        <sup>{{$category->products->count()}}</sup></a></li>
                @endforeach
            </ul>
        </div>
        <div class="ps-section__content pb-50">
            <div class="masonry-wrapper" data-col-md="4" data-col-sm="2" data-col-xs="1" data-gap="30"
                ...
                <div class="ps-masonry">
                    ...
                    <div class="grid-item {{$category['slug']}}">
                                ...
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                                        <div class="ps-shoe__variant normal">
                                            ...
                                            <img src="{{ asset('storage/images/products/'.$image->product_image) }}"
                                                alt="">
                                            @endforeach
                                        </div>
...
<div class="ps-section--offer">
    <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img
                src="assets/frontend/images/banner/home-banner-1.png" alt=""></a></div>
    <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img
                src="assets/frontend/images/banner/home-banner-2.png" alt=""></a></div>
</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                    <div class="ps-hotspot"><a class="point first active" href="javascript:;"><i class="fa fa-plus"></i>
                        ...
                        </a><img src="assets/frontend/images/hot-deal.png" alt=""></div>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="ps-shoe">
                        <div class="ps-shoe__thumbnail">
                            <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i
                                ...
                                src="{{ asset('storage/images/products/'.$feature->image) }}" alt=""><a
                                class="ps-shoe__overlay"
                                href="{{ route('product.details', ['slug'=> $product['slug']]) }}"></a>
                        </div>
                        <div class="ps-shoe__content">
                            <div class="ps-shoe__variants">
                                <div class="ps-shoe__variant normal"><img src="assets/frontend/images/shoe/2.jpg"
                                        alt=""><img src="assets/frontend/images/shoe/3.jpg" alt=""><img
                                        src="assets/frontend/images/shoe/4.jpg" alt=""><img
                                        src="assets/frontend/images/shoe/5.jpg" alt=""></div>
                                <select class="ps-rating ps-shoe__rating">
...
<div class="ps-home-testimonial bg--parallax pb-80" data-background="assets/frontend/images/background/parallax.jpg">
    <div class="container">
        <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0"
            ...
            <div class="ps-testimonial">
                <div class="ps-testimonial__thumbnail"><img src="assets/frontend/images/testimonial/1.jpg" alt=""><i
            ...
            <div class="ps-testimonial">
                <div class="ps-testimonial__thumbnail"><img src="assets/frontend/images/testimonial/2.jpg" alt=""><i
                        class="fa fa-quote-left"></i></div>
                <header>
                    <select class="ps-rating">
                        <option value="1">1</option>
            ...
            <div class="ps-testimonial">
                <div class="ps-testimonial__thumbnail"><img src="assets/frontend/images/testimonial/3.jpg" alt=""><i
                        class="fa fa-quote-left"></i></div>
                <header>
                    <select class="ps-rating">
                        <option value="1">1</option>
        ...
        <div class="ps-section__content">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                        <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img
                                src="assets/frontend/images/blog/1.jpg" alt=""></div>
                        <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.html">An Inside Look
                                at the
                                Breaking2 Kit</a>
                            <p class="ps-post__meta"><span>By:<a class="mr-5" href="blog.html">Alena Studio</a></span>
                                -<span class="ml-5">Jun 10, 2017</span></p>
                            <p>Leverage agile frameworks to provide a robust synopsis for high level overviews.
                                Iterative approaches
                                to corporate strategy foster collaborative thinking to further…</p><a
                                class="ps-morelink" href="blog-detail.html">Read more<i
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                        <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img
                                src="assets/frontend/images/blog/2.jpg" alt=""></div>
                        <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.html">Unpacking the
                                Breaking2 Race
                                Strategy</a>
                            <p class="ps-post__meta"><span>By:<a class="mr-5" href="blog.html">Alena Studio</a></span>
                                -<span class="ml-5">Jun 10, 2017</span></p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                        <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img
                                src="assets/frontend/images/blog/3.jpg" alt=""></div>
                        <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.html">Nike’s Latest
                                Football Cleat
                                Breaks the Mold</a>
                            <p class="ps-post__meta"><span>By:<a class="mr-5" href="blog.html">Alena Studio</a></span>
                                -<span class="ml-5">Jun 10, 2017</span></p>
...
<div class="ps-home-contact">
    <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29162.05186452099!2d90.63433161119526!3d23.986718437339267!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x37542da8a211c0cf%3A0x8aba1a78477a6b5c!2sGhorashal%20Fertilizer%20Factory%2C%20Palash!5e0!3m2!1sen!2sbd!4v1618038784211!5m2!1sen!2sbd"
...
<script type="text/javascript"
    src="{{ asset('assets/frontend/plugins/revolution/js/jquery.themepunch.tools.min.js') }}">
</script>
<script type="text/javascript"
    src="{{ asset('assets/frontend/plugins/revolution/js/jquery.themepunch.revolution.min.js') }}"></script>
<script type="text/javascript"
    src="{{ asset('assets/frontend/plugins/revolution/js/extensions/revolution.extension.video.min.js') }}">
</script>
<script type="text/javascript"
...
<script type="text/javascript"
    src="{{ asset('assets/frontend/plugins/revolution/js/extensions/revolution.extension.actions.min.js') }}">
</script>
<script type="text/javascript"
    src="{{ asset('assets/frontend/plugins/revolution/js/extensions/revolution.extension.kenburn.min.js') }}">
</script>
<script type="text/javascript"
    src="{{ asset('assets/frontend/plugins/revolution/js/extensions/revolution.extension.migration.min.js') }}">
</script>
@endpush
